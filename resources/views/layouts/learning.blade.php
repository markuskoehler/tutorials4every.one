...
<head>
    ...
    <link href="{{asset('themes/learning/html/css/vendor/all.css')}}" rel="stylesheet">
  ...
  TIP:
    ...
    <link href="{{asset('themes/learning/html/css/app/app.css')}}" rel="stylesheet">
...
<body>
<div id="app">
    @include('learning._parts.navigation')
...
<script src="{{asset('themes/learning/html/js/vendor/all.js')}}"></script>
...
<script src="{{asset('themes/learning/html/js/app/app.js')}}"></script>
